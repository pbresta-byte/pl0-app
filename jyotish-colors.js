/* =========================================================================
   ...
   Sources:
   - Graha colors: ch.2 (dhyana verses 6-13, Girish Chand ed.):
   ...
   - Cross-check: ch.3 v.16-17 complexions (Surya blood-red,
     Budha green-grass hue — iconographic vs body hue, both retained).
   - PP bird colors: p.53: Vulture white,
